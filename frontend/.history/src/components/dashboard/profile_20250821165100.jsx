...
const Profile = () => {
    ...
    return (
        <section className=" w-[1100px] h-[680px]  rounded-2xl p-8 flex flex-col menu">
            <div className="flex ">
                <img className="w-fit h-30 rounded-[50%] bg-amber-50 relative left-120 mb-20" src={image || ProfilePicture} alt="Profile Picture" />
                <button className="w-16 cursor-pointer hover:bg-amber-100 absolute left-226 top-73 justify-center items-center " onClick={handlePicture}><img className="w-4 h-4 " src={Upload} alt="" /></button>
            </div>
