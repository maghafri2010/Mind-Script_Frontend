    ...
    return (
        ...
        >
                <div className='flex flex-col justify-center items-start'>
                    ...
                    <div className={`flex gap-4 text-center  items-center border transition-all ease-in-out duration-300  mt-8  ${bol ? "w-[180px] ml-8 pl-4 rounded-2xl" : "w-[120px] text-[13px]" }`}>
                        <p className='text-cent'>name</p>
                    </div>
                    {labels.map((label, i) => (
                        <div 
                        key={i} 
