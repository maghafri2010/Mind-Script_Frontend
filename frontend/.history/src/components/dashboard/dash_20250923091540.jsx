...
import Navigator from "../navigators/navigatorTasks";
    ...
    return (
        <section className="flex flex-col w-full ">
            ...
            {bolTask && selectedIndex !== null && (
                <navigatorTasks labels={statusGroup[selectedIndex].tasks} onClose={() => setBolTask(false)} refreshTasks={loadTasks} />
            )}

            {bolTask && (
                <NavigatorReminders onClose={() => setBolReminder(false)}/>
            )}
