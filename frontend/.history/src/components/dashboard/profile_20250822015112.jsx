            ...
            <div className="flex flex-wrap justify-center gap-10">
                {labels.map((label, i) => (
                    <div className="flex flex-wrap gap-15  w-[470px]  ">
                        ...
                        {isEditing ? (
                            <input className="inputStyle edit" value={profile[labels[i]]} onChange={e => setProfile({ [keys[i]]: e.target.value})}/>
                        ) : (
                            <span className="inputStyle edit">{profile[labels[i]]}</span>
                        )}
