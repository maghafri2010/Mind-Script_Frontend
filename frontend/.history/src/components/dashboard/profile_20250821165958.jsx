...
const Profile = () => {
    ...
    return (
        <section className=" w-[1100px] h-[680px]  rounded-2xl p-8 flex flex-col menu">
            <div className="flex ">
                <img 
                className="w-32 h-32 object-cover rounded-full bg-amber-50 relative left-120 mb-8" 
                src={image || ProfilePicture} alt="Profile Picture" />
                <label className="w-fit px-8 py-1 rounded-b-[50%]  box hover:bg-amber-100 absolute left-218 top-72 justify-center items-center " >
