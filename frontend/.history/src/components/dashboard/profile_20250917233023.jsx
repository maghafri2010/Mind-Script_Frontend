...
// - Sending editProfile ensures the backend receives the current changes.
    ...
    const save = async () => {
        ...
        try {
            ...
            body: JSON.stringify({ user_id: parseInt(localStorage.getItem("userID")),username: editProfile.username, firstname: editProfile.firstname, lastname: editProfile.lastname, email: editProfile.email, phone: editProfile.phone})
            });
            if (res.ok)
            ...
            <div className="flex flex-wrap justify-center gap-10">
                ...
                {isEditing && (  
                    <div className="flex gap-20 mt-16">
                        ...
                        <button className="editButton bg-gray-500 text-[20px]" onClick={cancel}>Cancel</button>
                    </div>
                )}
