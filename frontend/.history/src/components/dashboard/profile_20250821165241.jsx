    ...
    return (
        <section className=" w-[1100px] h-[680px]  rounded-2xl p-8 flex flex-col menu">
            <div className="flex ">
                ...
                <button className="w-fit px-8 py-2 rounded-b-3xl cursor-pointer hover:bg-amber-100 absolute left-218 top-73 justify-center items-center " onClick={handlePicture}><img className="w-4 h-4 " src={Upload} alt="" /></button>
            </div>
