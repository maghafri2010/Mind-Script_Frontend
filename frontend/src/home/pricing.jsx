...
const Pricing = () => {
    ...
    return (
        <section className="flex flex-col justify-center items-center py-16 bg-[#9CD3D1]">
            ...
            <div className="flex border-2 mt-12 rounded-2xl">
                <div className=" bg-[#FAF4E1] rounded-tl-2xl rounded-bl-2xl p-6  w-[330px] h-[500px]">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[#8A8A8A]"> /month</p>
                        </div>
                        ...
                        {basic.map((text, i) => (
                            <p className="flex items-center gap-2"><img className="w-4 ml-2 h-4" src={Check} alt="" />{text}</p>
                        ))}
                ...
                <div className="bg-[#FAC9B3] p-6 border-x-2 w-[330px] h-[500px]">
                    <div className="flex items-center gap-4 mb-4">
                        <span className="bg-[#F7EABC] border-2 rounded-[50%] w-12 h-12"/>
                        <h2 className="text-3xl">Basic</h2>
                    </div>
                ...
                <div className="bg-[#FAF4E1] rounded-tr-2xl rounded-br-2xl p-6 w-[330px] h-[500px]">
                    <div className="flex items-center gap-4 mb-4">
                        <span className="bg-[#F7EABC] border-2 rounded-[50%] w-12 h-12"/>
                        <h2 className="text-3xl">Basic</h2>
                    </div>
