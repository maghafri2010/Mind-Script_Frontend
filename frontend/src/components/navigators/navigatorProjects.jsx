...
const NavigatorReminders = ({labels , onClose, refreshProjects}) => {
    ...
    const duplicateProject = async (index) => {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL}/api/projects/duplicate` , {
            method: "POST",
            headers: {"Content-Type": "application/json"},
            body: JSON.stringify({user_id: project.user_id, project_id: project.project_id})
        });
        if (res.ok)
